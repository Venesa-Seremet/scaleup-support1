...
public final class SystemEventsServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<etf.pnwt.grpc.SystemEventsRequest,
      etf.pnwt.grpc.SystemEventsResponse> getGetActionMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "getAction",
      requestType = etf.pnwt.grpc.SystemEventsRequest.class,
      responseType = etf.pnwt.grpc.SystemEventsResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<etf.pnwt.grpc.SystemEventsRequest,
      etf.pnwt.grpc.SystemEventsResponse> getGetActionMethod() {
    io.grpc.MethodDescriptor<etf.pnwt.grpc.SystemEventsRequest, etf.pnwt.grpc.SystemEventsResponse> getGetActionMethod;
      ...
      synchronized (SystemEventsServiceGrpc.class) {
        if ((getGetActionMethod = SystemEventsServiceGrpc.getGetActionMethod) == null) {
          SystemEventsServiceGrpc.getGetActionMethod = getGetActionMethod = 
              io.grpc.MethodDescriptor.<etf.pnwt.grpc.SystemEventsRequest, etf.pnwt.grpc.SystemEventsResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "SystemEventsService", "getAction"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  etf.pnwt.grpc.SystemEventsRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  etf.pnwt.grpc.SystemEventsResponse.getDefaultInstance()))
  ...
  public static abstract class SystemEventsServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void getAction(etf.pnwt.grpc.SystemEventsRequest request,
        io.grpc.stub.StreamObserver<etf.pnwt.grpc.SystemEventsResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                etf.pnwt.grpc.SystemEventsRequest,
                etf.pnwt.grpc.SystemEventsResponse>(
  ...
  public static final class SystemEventsServiceBlockingStub extends io.grpc.stub.AbstractStub<SystemEventsServiceBlockingStub> {
    ...
    /**
     */
    public etf.pnwt.grpc.SystemEventsResponse getAction(etf.pnwt.grpc.SystemEventsRequest request) {
  ...
  public static final class SystemEventsServiceFutureStub extends io.grpc.stub.AbstractStub<SystemEventsServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<etf.pnwt.grpc.SystemEventsResponse> getAction(
        etf.pnwt.grpc.SystemEventsRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_ACTION:
          serviceImpl.getAction((etf.pnwt.grpc.SystemEventsRequest) request,
              (io.grpc.stub.StreamObserver<etf.pnwt.grpc.SystemEventsResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class SystemEventsServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return etf.pnwt.grpc.SystemEvents.getDescriptor();
    }
